...
class DatabaseBoxHelper {
  static final DatabaseBoxHelper _instance = new DatabaseBoxHelper.internal();

  factory DatabaseBoxHelper() => _instance;
  static Database _db;
  ...
  DatabaseBoxHelper.internal();

  initDb() async {
    io.Directory documentsDirectory = await getApplicationDocumentsDirectory();
    String path = join(documentsDirectory.path, "box.db");
